...
class _AdvCarouselState extends State<AdvCarousel> with SingleTickerProviderStateMixin {
    ...
    return new Positioned(
        ...
        child: Container(
          ...
          child: AbsorbPointer(
            ...
            child: Opacity(
              child: widget.carouselController.carouselItems[currentPage.round()].button,
...
class AdvCarouselController extends ValueNotifier<AdvCarouselEditingValue> {
  ...
  AdvCarouselController({List<CarouselItem> carouselItems})
      : super(carouselItems == null
      ? AdvCarouselEditingValue.empty
      : new AdvCarouselEditingValue(carouselItems: carouselItems));

  AdvCarouselController.fromValue(AdvCarouselEditingValue value) : super(value ?? AdvCarouselEditingValue.empty);
...
class AdvCarouselEditingValue {
  const AdvCarouselEditingValue({this.carouselItems});
  ...
  AdvCarouselEditingValue copyWith({List<Widget> widgets}) {
    return new AdvCarouselEditingValue(carouselItems: widgets ?? this.carouselItems);
  }

  AdvCarouselEditingValue.fromValue(AdvCarouselEditingValue copy) : this.carouselItems = copy.carouselItems;
